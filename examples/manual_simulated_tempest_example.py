...
class manual_simulated_tempest_example(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Manual Simulated Tempest Example")
        ...
        self.usrp_rate = usrp_rate = int(50e6)
        ...
        self.tempest_image_source_0 = tempest.image_source('/home/emidan19/Downloads/Imagen_800_600.png', 800, 600, 1024, 624, 1)
        ...
        self.connect((self.rational_resampler_xxx_0, 0), (self.tempest_fine_sampling_synchronization_0, 0))
